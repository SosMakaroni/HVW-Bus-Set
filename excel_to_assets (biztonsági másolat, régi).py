...
def generate_lng(rows, cm):
    ...
    for row in rows:
        ...
        T1      = safe_val(row, cm['TextManufacturer'])
        T2      = safe_val(row, cm['TextType'])
        ...
        lines.append(
            ...
            f"{{GOLD}}----------{{BLACK}}{{}}Type: {{GOLD}}{comma2}{TO2}, {TO1}{{BLACK}}{{}}"
        )
...
def main():
    ...
    col_map = {
        ...
        'TextManufacturer':       find_column(cols, 'manufacturer'),
